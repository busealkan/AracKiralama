...
namespace AracKiralama.Sınıflar.Veritabanı
{
    ...
    {
        string yol = @"Data Source=DESKTOP-TSE883Q\SQLEXPRESS;Initial Catalog=TT_AracKiralama;Integrated Security=SSPI";
        ...
        {
            yol = @"Data Source=DESKTOP-TSE883Q\SQLEXPRESS;Initial Catalog=TT_AracKiralama;Integrated Security=SSPI";
        }
